...
- **Alumni Discovery**: Search and connect with alumni based on industry, company, skills
- **Mentorship Requests**: Request guidance from experienced professionals
- **Real-time Messaging**: Direct communication with alumni and peers
- **AI-Powered Insights**: Get career recommendations and profile optimization tips
- **Job Opportunities**: Access exclusive job postings from alumni employers

### For Alumni
- **Give Back**: Mentor students and share career insights
...
- **Profile Visibility**: Showcase current role, expertise, and availability for mentorship

### For Employers (External Users)
- **Student Search**: Discover talented students for hiring
- **Direct Messaging**: Connect with potential candidates
- **Job Posting**: Share opportunities with the student community
...
- `POST /api/profiles/certificates/` - Add certificate
